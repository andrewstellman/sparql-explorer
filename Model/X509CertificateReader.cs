...
namespace SparqlExplorer.Model
{
    ...
    /// <summary>
    /// Read X.509 certificate and key files
    /// </summary>
    /// <remarks>
    /// Adapted from http://www.codeproject.com/Articles/162194/Certificates-to-DB-and-Back
    /// </remarks>
    public class X509CertificateFileReader
    {
        public static X509Certificate2 ReadX509Certificate(string certFilename, string keyFilename)
        {
            string publicCert = File.ReadAllText(certFilename);
            byte[] certBuffer = Helpers.GetBytesFromPEM(publicCert, true);

            string privateKey = File.ReadAllText(keyFilename);
            byte[] keyBuffer = Helpers.GetBytesFromPEM(privateKey, false);
        ...
        /// <remarks>
        /// Adapted from http://www.codeproject.com/Articles/162194/Certificates-to-DB-and-Back file Crypto.cs
        /// </remarks>
        ...
        /// <remarks>
        /// Adapted from http://www.codeproject.com/Articles/162194/Certificates-to-DB-and-Back file Helpers.cs
        /// Replaced PemStringType enum with isPrivateKey boolean in GetBytesFromPEM()
        /// </remarks>
        private class Helpers
        {
            ...
            /// <returns></returns>
            public static byte[] GetBytesFromPEM(string pemString, bool isPublicKey)
            {
        ...
        /// <remarks>
        /// Adapted from http://www.codeproject.com/Articles/162194/Certificates-to-DB-and-Back file RSAParameterTraits.cs
        /// </remarks>
